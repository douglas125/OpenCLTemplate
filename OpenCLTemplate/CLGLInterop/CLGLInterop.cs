...
";
        ...
        public class GLVBOModel
        {
            ...
            /// <param name="Hint">OpenGL buffer usage hint</param>
            public void SetColorData(float[] ColorData, int offSet, BufferUsageHint Hint)
            {
                lock (this)
                {
                    ...
                    GL.BufferSubData(BufferTarget.ArrayBuffer, (IntPtr)(offSet * sizeof(float)), (IntPtr)(ColorData.Length * sizeof(float)), ColorData);
